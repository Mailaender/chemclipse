...
public class PageDataType extends AbstractExtendedWizardPage {
	...
	private static final DataType[] DATA_TYPES = new DataType[]{DataType.MALDI};
	//
	...
	public PageDataType() {
		...
		setTitle("Mass Spectra Batch Process");
	...
	private ComboViewer createComboViewerDataTypes(Composite parent) {
		...
		//
		comboViewer.setInput(new Object[]{"All Data Types", DataType.MALDI});
		combo.select(0);
		//
		return comboViewer;
	}
